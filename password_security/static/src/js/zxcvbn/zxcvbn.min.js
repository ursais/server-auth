                    ...
                    (scoring = require("./scoring")),
                        (feedback = {
                            ...
                            get_feedback: function(e, s) {
                                var a, t, r, n, o, i;
                                if (s.length === 0) return this.default_feedback;
                                if (e > 2) return {warning: "", suggestions: []};
                                for (
                                    n = s[0], i = s.slice(1), t = 0, r = i.length;
                                    t < r;
                                    t++
                                )
                                    (o = i[t]),
                                ...
                                return (
                                    (n =
                                        e.dictionary_name === "passwords"
                                            ...
                                            : e.dictionary_name === "english_wikipedia"
                                            ? s
                                                ? "A word by itself is easy to guess"
                                                : void 0
                                            : (a = e.dictionary_name) === "surnames" ||
                                              a === "male_names" ||
                                              a === "female_names"
                                            ? s
                    ...
                    (GRAPHS = {
                        ...
                        (matching = {
                                ...
                                for (n in t)
                                    for (
                                        ...
                                        for (
                                            ...
                                            u.slice(r, Number(i) + 1 || 9e9) in l &&
                                                ((p = u.slice(r, Number(i) + 1 || 9e9)),
                                                (c = l[p]),
                                                s.push({
                                                    pattern: "dictionary",
                                                    i: r,
                            ...
                            l33t_match: function(e, t, n) {
                                ...
                                for (
                                    ...
                                    for (
                                        ...
                                        if (
                                            ((o = f[l]),
                                            (m = e.slice(o.i, Number(o.j) + 1 || 9e9)),
                            ...
                            spatial_match: function(e, t) {
                                ...
                                for (r in t)
                                    (n = t[r]),
                                        this.extend(
                                            i,
                                            this.spatial_match_helper(e, n, r)
                                        );
                                return this.sorted(i);
                            },
                            ...
                            date_match: function(e) {
                                ...
                                for (
                                    ...
                                    for (
                                        ...
                                        if (
                                            ((M = e.slice(s, Number(o) + 1 || 9e9)),
                                            f.exec(M))
                                        ) {
                                            for (
                                                r = [],
                                                    T = DATE_SPLITS[M.length],
                                                    E = 0,
                                                    c = T.length;
                                                E < c;
                                                E++
                                                ...
                                                (D = T[E]),
                                                    ...
                                                    (a = this.map_ints_to_dmy([
                                                        parseInt(M.slice(0, h)),
                                                        parseInt(M.slice(h, u)),
                                                        parseInt(M.slice(u)),
                                                    ])),
                                                    a != null && r.push(a);
                                            if (r.length > 0) {
                            ...
                            map_ints_to_dmy: function(e) {
                                ...
                                if (!(e[1] > 31 || e[1] <= 0)) {
                                    for (
                                        o = 0, h = 0, p = 0, s = 0, r = e.length;
                                        s < r;
                                        s++
                                    ) {
                                        if (
                                            ((n = e[s]),
                                            (n > 99 && n < DATE_MIN_YEAR) ||
                                                n > DATE_MAX_YEAR)
                                        )
                                            return;
                                        n > 31 && (h += 1),
                        ...
                        (scoring = {
                            ...
                            spatial_guesses: function(e) {
                                ...
                                for (
                                    ...
                                    for (
                                        ...
                                        a +=
                                            this.nCk(u - 1, i - 1) * l * Math.pow(s, i);
                                if (e.shifted_count)
                                    if (
                                        ((r = e.shifted_count),
                            ...
                            dictionary_guesses: function(e) {
                                ...
                                return (
                                    ...
                                    (e.uppercase_variations = this.uppercase_variations(
                                        e
                                    )),
